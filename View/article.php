    ...
    <div id="articles">
        ...
        <?php foreach ($main_article as $new) { ?>
            ...
            if (isset($_SESSION['rang']) and $_SESSION['rang'] == 1 || $_SESSION['rang'] == 0) {
                    ?>
                    <div id="comment">
                        <form action="index.php?controler=commentaires&action=to_comment&id=<?= $new->id_billet ?>" method="post">
            ...
            <?php foreach ($related_comments as $comment) { ?>
                ...
                <div id=comments>
                    ...
                    <?php if (isset($_SESSION['rang']) and $_SESSION['rang'] == 1) { ?>
                        ...
                        <a href="index.php?controler=commentaires&action=to_edit_com&id1=<?= $comment->id_billet ?>&id2=<?= $comment->id_com ?>"><i
                                    class="far fa-edit"></i></a>

                        <a href="index.php?controler=commentaires&action=to_delete_com&idAlt1=<?= $comment->id_billet ?>&idAlt2=<?= $comment->id_com ?>"><i
